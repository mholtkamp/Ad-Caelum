...
public class DunGenNEW : MonoBehaviour {
	...
	void Start () 
	{
		...
		*/
		...
		//outputMapFile ();
		print (enemyCount + "Everything Else");
		createTiles();
		createWalls();
	...
	private void setGenParameters()
	{
		...
		if(lh.level == 1)
		{
			...
			enemyCount = 12;
			//enemyCount = (int)(enemyCount * (difficulty/2f));
			print (enemyCount + "HIYA");
			enemyMin = 0;
			enemyMax = 3;
